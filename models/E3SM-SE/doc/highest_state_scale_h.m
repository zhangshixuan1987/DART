...
% plots the vertical damping profile for E3SM, WACCM
%
...
%
%  diffusion_flag = E3SM namelist div24del2flag value, except for 0, which is not used by E3SM;
%                  0  for E3SM-SE,
%                  2  for E3SM-FV  div2 damping
%                  4  for E3SM-FV  div4 damping
%                  24 for E3SM-FV  del2+div4 damping
%
...
%
%  Optional arguments:
%  nu_top = needed only for E3SM-SE (diffusion_flag = 0).
%              Get from E3SM's atm_in namelist.
%
% Plot E3SM's (WACCM's) extra diffusion in the top layers
% These are functions of E3SM's ptop and -FV's div24del2flag.
...
% as well as E3SM's ptop and div24del2flag.
%
% EXAMPLE:
% fname         = 'caminput.nc';
% diffusion_flag = 2;
...
if (diffusion_flag == 0)
    % Calculate the "regular diffusion" in the top 3 layers for E3SM-SE
    diff_bot_k = 3;
...
lh = legend(legend_handles,'obs impact limit','extra "distance"', ...
    'highest\_state\_scale\_height','scale height at model top','E3SM \tau');
