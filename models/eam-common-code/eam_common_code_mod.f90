...
use  netcdf_utilities_mod,  only : nc_get_variable, nc_get_variable_size, nc_create_file, &
                                   ...
                                   nc_get_dimension_size, nc_global_attribute_exists
...
public :: nc_write_model_atts, grid_data, read_grid_info, set_eam_variable_info, &
...
subroutine set_eam_variable_info(eam_template_filename, variable_array)

character(len=*), intent(in)  :: eam_template_filename
character(len=*), intent(in)  :: variable_array(:)

character(len=*), parameter :: routine = 'set_eam_variable_info:'
...
! EAM only has a single domain (only a single grid, no nests or multiple grids)

domain_id = add_domain(eam_template_filename, nfields, var_names, kind_list, &
                       clamp_vals, update_list)

end subroutine set_eam_variable_info
