...
use eam_common_code_mod, only : nc_write_model_atts, grid_data, read_grid_info, &
                                set_eam_variable_info, MAX_STATE_VARIABLES, &
...
! to set up what will be read into the eam state vector
call set_eam_variable_info(eam_template_filename, state_variables)
